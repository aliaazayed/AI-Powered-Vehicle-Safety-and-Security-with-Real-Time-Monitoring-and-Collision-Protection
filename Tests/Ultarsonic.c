...
int main(void)
{
	...
	/* Loop forever */
	for(;;){
		MTIMER1_init(PWM_channel_2_IN);
		HULTRA_attachPin(DIOA,PIN3,TIMER1_CH2_PORTA_9);
		HULTRA_Trig(DIOA, PIN3);
		uint16_t value3 =HULTRA_Distance(1,TIMER1_CH2_PORTA_9);
		void disable();
		MTIMER3_init(PWM_channel_2_IN);
		HULTRA_attachPin(DIOA,PIN1,TIMER3_CH2_PORTA_7);
		HULTRA_Trig(DIOA, PIN1);
		uint16_t value1 =HULTRA_Distance(3,TIMER3_CH2_PORTA_7);
		void disable();
		MTIMER3_init(PWM_channel_3_IN);
		HULTRA_attachPin(DIOA,PIN2,TIMER3_CH3_PORTB_0);
		HULTRA_Trig(DIOA, PIN2);
		uint16_t value2 =HULTRA_Distance(3,TIMER3_CH3_PORTB_0);
		void disable();
		MTIMER3_init(PWM_channel_1_IN);
		HULTRA_attachPin(DIOA,PIN0,TIMER3_CH1_PORTA_6);
		HULTRA_Trig(DIOA, PIN0);
		uint16_t value =HULTRA_Distance(3,TIMER3_CH1_PORTA_6);
		void disable();
