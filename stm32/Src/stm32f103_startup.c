 ...
 * @brief STM32F103 Startup Code converted from C++ to C
 * @version 0.1
 * @date 2024-07-18
 * 
...
extern uint32_t _edata;  // marks the end of the initialized data section
extern uint32_t _sbss;   // marks the start of the BSS section
extern uint32_t _ebss;   // marks the end of the BSS section
